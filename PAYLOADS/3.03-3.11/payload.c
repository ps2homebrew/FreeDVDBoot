...
__attribute__((noreturn)) void ExecPS2(void *entry, void *gp, int argc, char **argv)
{
    ...
    // TODO: warning: `noreturn' function does return
}
...
#define RELATIVE_SECTOR LOAD_FROM_SECTOR_RELATIVE_TO_VIDEO_TS_IFO
    ...
    // Based on https://github.com/ps2homebrew/uLaunchELF/blob/master/loader/loader.c
    elf_header_t eh;
    ...
    // TODO: warning: passing arg 4 of `ExecPS2' from incompatible pointer type
}
